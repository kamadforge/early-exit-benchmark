...
from architectures.pretrained import get_efficientnet_v2_s_pretrained, get_vit_b_16_pretrained, get_efficientnet_b0_pretrained, get_convnext_t_pretrained, \
    get_swin_v2_s_pretrained, get_vit_b_16_adapt_head
from architectures.resnets import ResNet50, ResNet101, ResNet152, ResNet34, ResNet18
from architectures.tv_models import get_efficientnet_v2_s
...
def get_default_args():
    ...
    default_args.early_stopping = False  # use early exiting in training
    default_args.early_stopping_patience = 10  # number of epochs with no improvement after which training will be stopped
    default_args.early_stopping_delta = 0.0  # minimum change in the loss to qualify as an improvement
    default_args.early_stopping_metric_type = 'loss'  # the type of used metric to stop trening earlier (acc / loss)
    default_args.with_phase3 = False  # whether to include the third phase into the traning
    default_args.train_val_split_test_size = 0.1  # fraction of training dataset that will be split into training and validation dataset
    default_args.train_val_split_seed = 42  # random seed when splitting traing dataset into training and validation dataset
...
MODEL_NAME_MAP = {
    ...
    'tv_convnext_t_pretrained': get_convnext_t_pretrained,
    'tv_efficientnet_b0_pretrained': get_efficientnet_b0_pretrained,
    'tv_efficientnet_s_pretrained': get_efficientnet_v2_s_pretrained,
    'tv_vit_b_16_pretrained': get_vit_b_16_pretrained,
    'tv_swin_v2_s_pretrained': get_swin_v2_s_pretrained,
    'tv_efficientnet_s': get_efficientnet_v2_s,
    'tv_vit_b_16_adapt_head': get_vit_b_16_adapt_head
}
