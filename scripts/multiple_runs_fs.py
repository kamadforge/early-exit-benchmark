...
def main():
    ...
    exp_names = ['cifar10_resnet50_2T5WWDXM', 'cifar10_sdn_5MGCTDFH', 'cifar10_sdn_2R3BNYXM', 'cifar10_sdn_JEVO7YRR', 'cifar10_sdn_56H6WYXL']
    display_names = ['ResNet-50', '0:200', '50:150', '100:100', '150:50']
    ...
    output_dir = Path(os.environ["RESULTS_DIR"]) / out_dir_name / "together2"
