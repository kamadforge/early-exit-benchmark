...
def main():
    ...
    common_args.epochs = 3000  # == 0 indicates that phase 1 lasts 0 epochs
    ...
    common_args.optimizer_args.lr = 0.2
    ...
    sdn_model_args.epochs_common = 3000  # == 0 indicates that phase 2 lasts 0 epochs
    sdn_model_args.with_phase3 = False
    sdn_model_args.epochs = 3000 + sdn_model_args.epochs_common
    sdn_model_args.with_backbone = True if sdn_model_args.epochs_common != 0 else False
    common_args.local_description = f'+-+'
    ...
    sdn_model_args.optimizer_args.lr = 0.02
