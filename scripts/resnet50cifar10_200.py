...
def main():
    ...
    common_args.optimizer_args.lr = 0.05
    ...
    sdn_model_args.epochs = 200 - common_args.epochs
    ...
    sdn_model_args.optimizer_args.lr = 0.05
    sdn_model_args.optimizer_args.weight_decay = 0.0005
    ...
    output_dir = Path(os.environ["RESULTS_DIR"]) / out_dir_name / f"{sdn_model_exp_name}"
