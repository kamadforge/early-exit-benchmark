...
from visualize.ee_landscape import visualize_ee_landscape

# command:
# python -m scripts.landscape_plot
...
def main():
    ...
    for idx in exp_ids:
        ...
        plot_args.clips = [0.03, 0.1, 0.3, 1.0, 3.0, 5.0, 10.0, 20.0, 30.0]
        plot_args.zoom = 1.0
        plot_args.only_heads = False
        plot_args.only_backbone = False

        submit_job(executor, visualize_ee_landscape, plot_args)
