...
def main():
    ...
    common_args.dataset_args.resize = 224 # Upsizing cifar100 to use model pretrained on this resolution. This has been used by the community.
    ...
    common_args.early_stopping_patience = 10
    ...
    common_args.optimizer_args.lr = 0.1
    ...
    base_model_args.model_args.num_classes = 100
    ...
    sdn_model_args.epochs_common = 200  # == 0 indicates that phase 2 lasts 0 epochs
    sdn_model_args.with_phase3 = False
    sdn_model_args.epochs = 0 + sdn_model_args.epochs_common
    ...
    sdn_model_args.optimizer_args.lr = 0.1
