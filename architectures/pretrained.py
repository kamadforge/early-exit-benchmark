...
def get_efficientnet_b0_pretrained():
...
def get_efficientnet_v2_s_pretrained():
...
def get_vit_b_16_adapt_head(num_classes=1000, image_size=224):
    model = torchvision.models.vit_b_16(ViT_B_16_Weights.IMAGENET1K_V1, progress=False)
    model.heads.head = torch.nn.Linear(768, num_classes, bias=True)
